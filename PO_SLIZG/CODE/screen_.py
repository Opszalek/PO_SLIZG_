...
#                             
    ...
    def screen_stats(self,current):
        ...
        if v1>v2:
            for i in range(240-v2,240-v1,-1):
...
#         display.text(font_32,str(power),160,74,st7789.color565(89,90,89),st7789.WHITE)
    ...
    def screen_select(self,screen,vel,current):
        self.vel_act=vel
        if screen==1:
            self.screen_main()
        elif screen==2:
            self.screen_stats(current)
...
while True:
    ...
    tft.screen_select(2,40,potentiometer_value)
